...
START_TEST(t1) {
  ...
  int res = s21_is_greater_or_equal(decimal1, decimal2);
...
Suite *suite_is_greater_or_equal() {
  Suite *suite = suite_create("decimal is greater or equal");
  TCase *tcase_core = tcase_create("is_greater_or_equal_tc");
